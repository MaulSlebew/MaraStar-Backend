...
@section('content')
    <div class="mb-8 flex flex-wrap items-end justify-between gap-4">
        <div>
            ...
            <h1 class="font-display text-3xl font-bold tracking-tight text-zinc-900 md:text-4xl">Tambah Size</h1>
            <p class="mt-1 text-sm text-zinc-500">Buat ukuran baru yang bisa dipakai di produk.</p>
        </div>
    ...
    <div class="max-w-md rounded-xl border border-zinc-200 bg-white p-6">
        <form action="{{ route('sizes.store') }}" method="POST">
            ...
            <div class="flex flex-wrap gap-3">
                <button type="submit" class="button">Simpan Size</button>
