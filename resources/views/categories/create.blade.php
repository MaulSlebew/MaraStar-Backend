...
@section('content')
    <div class="mb-8 flex flex-wrap items-end justify-between gap-4">
        <div>
            ...
            <h1 class="font-display text-3xl font-bold tracking-tight text-zinc-900 md:text-4xl">Tambah Kategori</h1>
            <p class="mt-1 text-sm text-zinc-500">Buat kategori baru untuk mengelompokkan produk.</p>
        </div>
        ...
        <form action="{{ route('categories.store') }}" method="POST">
            ...
            <div class="mb-5">
                ...
                <input
                    ...
                    placeholder="Misal: T-Shirt, Hoodie, Jaket"
